...
$data = array(
    ...
    foreach ($data as $key => $value) {
      $imc = ($data[$key]['Poids']) / pow($data[$key]['Taille']/100,2);
      echo "<tr>";
      echo  "<td>". $data[$key]['Nom'] ."</td><td>". $data[$key]['Prenom'] ."</td><td>". $data[$key]['Email'] ."</td><td>". $data[$key]['Taille'] ."</td><td>". $data[$key]['Poids'] ."</td><td>" . $imc . "</td></tr>";
    }
    ?>
    </table>
  </body>
